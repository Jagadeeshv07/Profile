...
- **Cloud Services** : AWS (EC2, S3, IAM, VPC, SNS, CloudWatch).
...
- Integrated automation runs with Jenkins pipelines and Git for continuous testing.
- Deployed Docker containers to isolate test environments, improving stability and reproducibility.
- Used AWS EC2, S3, and CloudWatch for distributed test execution and monitoring.
- Collaborated with DevOps teams to enhance CI/CD pipelines with Terraform modules for reusable infrastructure.
...
- Created and executed test cases for Android-based agricultural equipment using Polarion.
- Performed **smoke, sanity, system, and regression testing** ensuring high product quality before releases.
- Used Linux and ADB for device validation and defect debugging.
